...
<body>
	...
	<div class="container">
		...
		<%
			int i = 0;
			for (ThanhVien dscurrentstudents : gettingthanhvien.getListCurrentThanhVien()) {
				i++;
				if (i % 3 == 1) {
		%>
		<div class="row">
			...
			<div class='col-md-4'>
				<div class="row">
					<div class='col-md-4'>
						<%
							if (dscurrentstudents.getAvatar() != null) {
						%>
						<img class="img-circle"
							src="/ManagementLab/images/member/<%=dscurrentstudents.getAvatar()%>"
					...
					<div class='col-md-8'>
						<%
							out.println("<h4 style='color: blue'>" + dscurrentstudents.getHoTen() + "</h4>");
								out.println("<p><b>Mã TV: </b>" + dscurrentstudents.getMaTV() + "</p>");
								out.println("<p><b>Điện thoại: </b>" + dscurrentstudents.getSoDT() + "</p>");
								out.println("<p><b>Nhóm: </b>" + dscurrentstudents.getMaNhom() + "</p>");
								out.println("<h1></h1>");
						%>
					</div>

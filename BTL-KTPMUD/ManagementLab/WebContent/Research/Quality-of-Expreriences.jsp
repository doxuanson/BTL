...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
				<h2>
					<a href="Research-Quality-of-Expreriences"><i class="fa fa-home" aria-hidden="true"></i>
						QoS</a>
				</h2>
				<hr />
				<h2>
				...
				<h2>
					...
					<%
						for (ThanhVien nhomtruong : gettingthanhvien.getListQoSLeader()) {
					%>
				...
				<%
					for (ThanhVien dsthanhvien : gettingthanhvien.getListQoSThanhVien()) {
				%>

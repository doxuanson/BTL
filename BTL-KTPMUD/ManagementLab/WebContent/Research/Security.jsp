...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
				<h2>
					<a href="Research-Security"><i class="fa fa-home"
						aria-hidden="true"></i> Security</a>
				</h2>
				<hr />
				<h2>
				...
				<h2>
					...
					<%
						for (ThanhVien nhomtruong : gettingthanhvien.getListSELeader()) {
					%>

				</h2>
				<p>
					<b><%=nhomtruong.getHoTen()%></b>
				</p>
				<%
					}
				%>
				...
				<%
					for (ThanhVien dsthanhvien : gettingthanhvien.getListSEThanhVien()) {
				%>

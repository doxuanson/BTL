...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
				<h2>
					<a href="Research-Internet-of-Things"><i class="fa fa-home"
						aria-hidden="true"></i> IoT</a>
				</h2>
				<hr />
				<h2>
				...
				<h2>
					...
					<%
						for (ThanhVien nhomtruong : gettingthanhvien.getListIoTLeader()) {
					%>
				...
				<%
					for (ThanhVien dsthanhvien : gettingthanhvien.getListIoTThanhVien()) {
				%>

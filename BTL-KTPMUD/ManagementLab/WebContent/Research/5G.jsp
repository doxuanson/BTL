...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
				<h2>
					<a href="Research-5G"><i class="fa fa-home" aria-hidden="true"></i>
						5G</a>
				</h2>
				<hr />
				<h2>
				...
				<h2>
					...
					<%
						for (ThanhVien nhomtruong : gettingthanhvien.getList5GLeader()) {
					%>
				...
				<%
					for (ThanhVien dsthanhvien : gettingthanhvien.getList5GThanhVien()) {
				%>

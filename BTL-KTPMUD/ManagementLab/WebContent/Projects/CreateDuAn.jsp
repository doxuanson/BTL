...
<body>
	...
	<div class="container">
		<form action="HandleProject" method="post">
			<center>
				<h1 style="color: green">Create Project</h1>
			</center>
			<%
			...
			<div class="input-group">
				...
				<input type="text" class="form-control" placeholder="Tên project"
					aria-describedby="basic-addon1" name="project_name">
			</div>
			<br />
			<div class="input-group">
				<span class="input-group-addon" id="basic-addon1">Đối tác</span> <input
					type="text" class="form-control" placeholder="Đối tác"
					aria-describedby="basic-addon1" name="doitac">
			</div>
			<br />
			<div class="input-group">
				<span class="input-group-addon" id="basic-addon1">Mô tả</span> <input
					type="text" class="form-control" placeholder="Mô tả"
			...
			<div class="input-group">
				<span class="input-group-addon" id="basic-addon1">Trạng thái
					...
					placeholder="Trạng thái dự án" aria-describedby="basic-addon1"
					name="trangthai">
			</div>
			<br />
			<div class="input-group">
				<span class="input-group-addon" id="basic-addon1">Thành viên</span>
				<input type="text" class="form-control" placeholder=""
					aria-describedby="basic-addon1" name="thanhvien">
			</div>
			<h3></h3>

			<center>
				<input class="btn btn-success" type="submit" value="Create_Project"
					name="command" />
			</center>
		</form>
	</div>

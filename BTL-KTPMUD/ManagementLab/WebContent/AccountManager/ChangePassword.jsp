	...
	<center>
		<form action="LoginController" method="POST">
			<%
				if (thanhvien != null) {
			%>
			<input type="hidden" value="<%=thanhvien.getMaTV()%>" name="matv" />
			<%
				}
			%>
			...
			<p>
				Confirm new password: <input type="password" name="newpasswordcheck" />
			</p>
			<%
			...
			<br /> <input type="hidden" value="changepassword" name="command" />
